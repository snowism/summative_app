...
export default class SelectBrand extends Component {
    render() {
      ...
      <div className="select-box">
        ...
        <Link to="/show-nike"><div className="logo-box"><img src="./images/logo_a.png"/></div></Link>
        <Link to="/show-nike"><div className="logo-box"><img src="./images/logo_j.png"/></div></Link>
